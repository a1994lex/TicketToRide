...
//        for (String username : keys)
    ...
    private  void makeBank(){
        ...
        routeMap.put(2, new Route(1, "SEATTLE", "PORTLAND", 1, "", 2));
        routeMap.put(3, new Route(5, "PORTLAND", "SAN FRANCISCO", 10, "green", 3));
        routeMap.put(4, new Route(5, "PORTLAND", "SAN FRANCISCO", 10, "pink", 4));
        routeMap.put(5, new Route(3, "SAN FRANCISCO", "LOS ANGELES", 4, "yellow", 5));
        routeMap.put(6, new Route(3, "SAN FRANCISCO", "LOS ANGELES", 4, "pink", 6));
        routeMap.put(7, new Route(3, "VANCOUVER", "CALGARY", 4, "", 7));
        routeMap.put(8, new Route(4, "SEATTLE", "CALGARY", 7, "", 8));
        routeMap.put(9, new Route(6, "SEATTLE", "HELENA", 15, "yellow", 9));
        routeMap.put(10, new Route(6, "PORTLAND", "SALT LAKE CITY", 15, "blue", 10));
        routeMap.put(11, new Route(5, "SAN FRANCISCO", "SALT LAKE CITY", 10, "orange", 11));
        routeMap.put(12, new Route(5, "SAN FRANCISCO", "SALT LAKE CITY", 10, "white", 12));
        routeMap.put(13, new Route(2, "LOS ANGELES", "LAS VEGAS", 2, "", 13));
        routeMap.put(14, new Route(3, "LOS ANGELES", "PHOENIX", 4, "", 14));
        routeMap.put(15, new Route(6, "LOS ANGELES", "EL PASO", 15, "black", 15));
        routeMap.put(16, new Route(6, "CALGARY", "WINNIPEG", 15, "white", 16));
        routeMap.put(17, new Route(4, "CALGARY", "HELENA", 7, "", 17));
        routeMap.put(18, new Route(3, "SALT LAKE CITY", "HELENA", 4, "pink", 18));
        routeMap.put(19, new Route(3, "SALT LAKE CITY", "DENVER", 4, "red", 19));
        routeMap.put(20, new Route(3, "SALT LAKE CITY", "DENVER", 4, "yellow", 20));
        routeMap.put(21, new Route(3, "LAS VEGAS", "SALT LAKE CITY", 4, "orange", 21));
        routeMap.put(22, new Route(5, "PHOENIX", "DENVER", 10, "white", 22));
        routeMap.put(23, new Route(3, "PHOENIX", "SANTA FE", 4, "", 23));
        routeMap.put(24, new Route(3, "PHOENIX", "EL PASO", 4, "", 24));
        routeMap.put(25, new Route(4, "HELENA", "WINNIPEG", 7, "blue", 25));
        routeMap.put(26, new Route(6, "HELENA", "DULUTH", 15, "orange", 26));
        routeMap.put(27, new Route(5, "HELENA", "OMAHA", 10, "red", 27));
        routeMap.put(28, new Route(4, "HELENA", "DENVER", 7, "green", 28));
        routeMap.put(29, new Route(2, "DENVER", "SANTA FE", 2, "", 29));
        routeMap.put(30, new Route(4, "DENVER", "OMAHA", 7, "pink", 30));
        routeMap.put(31, new Route(4, "DENVER", "KANSAS CITY", 7, "black", 31));
        routeMap.put(32, new Route(4, "DENVER", "KANSAS CITY", 7, "orange", 32));
        routeMap.put(33, new Route(4, "DENVER", "OKLAHOMA CITY", 7, "red", 33));
        routeMap.put(34, new Route(3, "SANTA FE", "OKLAHOMA CITY", 4, "blue", 34));
        routeMap.put(35, new Route(2, "SANTA FE", "EL PASO", 2, "", 35));
        routeMap.put(36, new Route(5, "EL PASO", "OKLAHOMA CITY", 10, "yellow", 36));
        routeMap.put(37, new Route(4, "EL PASO", "DALLAS", 7, "red", 37));
        routeMap.put(38, new Route(6, "EL PASO", "HOUSTON", 15, "green", 38));
        routeMap.put(39, new Route(4, "WINNIPEG", "DULUTH", 7, "black", 39));
        routeMap.put(40, new Route(6, "WINNIPEG", "SAULT ST. MARIE", 15, "", 40));
        routeMap.put(41, new Route(3, "DULUTH", "SAULT ST. MARIE", 4, "", 41));
        routeMap.put(42, new Route(6, "DULUTH", "TORONTO", 15, "pink", 42));
        routeMap.put(43, new Route(3, "DULUTH", "CHICAGO", 4, "red", 43));
        routeMap.put(44, new Route(2, "DULUTH", "OMAHA", 2, "", 44));
        routeMap.put(45, new Route(4, "OMAHA", "CHICAGO", 7, "blue", 45));
        routeMap.put(46, new Route(1, "OMAHA", "KANSAS CITY", 1, "", 46));
        routeMap.put(47, new Route(2, "KANSAS CITY", "SAINT LOUIS", 2, "blue", 47));
        routeMap.put(48, new Route(2, "KANSAS CITY", "SAINT LOUIS", 2, "pink", 48));
        routeMap.put(49, new Route(2, "KANSAS CITY", "OKLAHOMA CITY", 2, "", 49));
        routeMap.put(50, new Route(2, "OKLAHOMA CITY", "LITTLE ROCK", 2, "", 50));
        routeMap.put(51, new Route(2, "OKLAHOMA CITY", "DALLAS", 2, "", 51));
        routeMap.put(52, new Route(1, "DALLAS", "HOUSTON", 1, "", 52));
        routeMap.put(53, new Route(2, "DALLAS", "LITTLE ROCK", 2, "", 53));
        routeMap.put(54, new Route(2, "HOUSTON", "NEW ORLEANS", 2, "", 54));
        routeMap.put(55, new Route(3, "LITTLE ROCK", "NEW ORLEANS", 4, "green", 55));
        routeMap.put(56, new Route(3, "LITTLE ROCK", "NASHVILLE", 4, "white", 56));
        routeMap.put(57, new Route(2, "SAINT LOUIS", "LITTLE ROCK", 2, "", 57));
        routeMap.put(58, new Route(2, "SAINT LOUIS", "NASHVILLE", 2, "", 58));
        routeMap.put(59, new Route(5, "SAINT LOUIS", "PITTSBURGH", 10, "", 59));
        routeMap.put(60, new Route(2, "SAINT LOUIS", "CHICAGO", 2, "green", 60));
        routeMap.put(61, new Route(2, "SAINT LOUIS", "CHICAGO", 2, "white", 61));
        routeMap.put(62, new Route(3, "CHICAGO", "PITTSBURGH", 4, "orange", 62));
        routeMap.put(63, new Route(3, "CHICAGO", "PITTSBURGH", 4, "black", 63));
        routeMap.put(64, new Route(4, "CHICAGO", "TORONTO", 7, "white", 64));
        routeMap.put(65, new Route(5, "SAULT ST. MARIE", "MONTREAL", 10, "black", 65));
        routeMap.put(66, new Route(2, "SAULT ST. MARIE", "TORONTO", 2, "", 66));
        routeMap.put(67, new Route(3, "TORONTO", "MONTREAL", 4, "", 67));
        routeMap.put(68, new Route(2, "TORONTO", "PITTSBURGH", 2, "", 68));
        routeMap.put(69, new Route(2, "MONTREAL", "BOSTON", 2, "", 69));
        routeMap.put(70, new Route(3, "MONTREAL", "NEW YORK", 4, "blue", 70));
        routeMap.put(71, new Route(2, "BOSTON", "NEW YORK", 2, "yellow", 71));
        routeMap.put(72, new Route(2, "BOSTON", "NEW YORK", 2, "red", 72));
        routeMap.put(73, new Route(2, "PITTSBURGH", "NEW YORK", 2, "white", 73));
        routeMap.put(74, new Route(2, "PITTSBURGH", "NEW YORK", 2, "green", 74));
        routeMap.put(75, new Route(2, "NEW YORK", "WASHINGTON", 2, "orange", 75));
        routeMap.put(76, new Route(2, "NEW YORK", "WASHINGTON", 2, "black", 76));
        routeMap.put(77, new Route(2, "PITTSBURGH", "WASHINGTON", 2, "", 77));
        routeMap.put(78, new Route(4, "NASHVILLE", "PITTSBURGH", 7, "yellow", 78));
        routeMap.put(79, new Route(3, "NASHVILLE", "RALEIGH", 4, "black", 79));
        routeMap.put(80, new Route(1, "NASHVILLE", "ATLANTA", 1, "", 80));
        routeMap.put(81, new Route(4, "NEW ORLEANS", "ATLANTA", 7, "yellow", 81));
        routeMap.put(82, new Route(4, "NEW ORLEANS", "ATLANTA", 7, "orange", 82));
        routeMap.put(83, new Route(6, "NEW ORLEANS", "MIAMI", 15, "red", 83));
        routeMap.put(84, new Route(5, "ATLANTA", "MIAMI", 10, "blue", 84));
        routeMap.put(85, new Route(2, "ATLANTA", "RALEIGH", 2, "", 85));
        routeMap.put(86, new Route(2, "ATLANTA", "CHARLESTON", 2, "", 86));
        routeMap.put(87, new Route(4, "CHARLESTON", "MIAMI", 7, "pink", 87));
