...
import com.groupryan.server.models.LongestPathCalc;
...
public class EndGameFacade {
    ...
    public void end(String gameId) {
        ...
        ArrayList<Player> longestPathPlayersList = longestPath(serverGame);
        ...
        for (Player p : players) {
            ...
            if (longestPathPlayersList.contains(p)) {
                endGameStat.setLongestPath(10);
                endGameStat.setTotalPoints(p.getPoints() + 10);
            } else {
                endGameStat.setLongestPath(0);
                endGameStat.setTotalPoints(p.getPoints() + 0);
            }
    ...
    private ArrayList<Player> longestPath(ServerGame serverGame) {
        LongestPathCalc lpCalc = new LongestPathCalc();
        return lpCalc.getLongestPathInGame(serverGame);
    }
